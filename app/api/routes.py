...
def backtest_options(
    ...
    return {
        ...
        "defaults": {
            ...
            "use_event_quality_filter": bool(getattr(settings, "backtest_use_event_quality_filter", False)),
            "event_quality_min_score": int(getattr(settings, "backtest_event_quality_min_score", 70)),
            "event_quality_fail_open": bool(getattr(settings, "backtest_event_quality_fail_open", True)),
...
def queue_backtest(
    ...
    params = {
        ...
        "intraday_flatten": _payload_bool(
            payload,
            "intraday_flatten",
            bool(getattr(settings, "backtest_intraday_flatten", False)),
        ),
        ...
        "event_quality_min_score": _payload_int(
            ...
            int(getattr(settings, "backtest_event_quality_min_score", 70)),
            minimum=0,
            maximum=100,
        ),
        "event_quality_fail_open": _payload_bool(
            ...
            bool(getattr(settings, "backtest_event_quality_fail_open", True)),
        ),
