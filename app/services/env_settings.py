    ...
    def snapshot(self, settings: Settings) -> dict[str, Any]:
        return {
            ...
            "editable": {
                ...
                "LIVE_MAX_NET_LONG_EXPOSURE_PCT": settings.live_max_net_long_exposure_pct,
                "LIVE_MAX_NET_SHORT_EXPOSURE_PCT": settings.live_max_net_short_exposure_pct,
                "LIVE_MAX_SAME_DIRECTION_POSITIONS": settings.live_max_same_direction_positions,
                "LIVE_MAX_SAME_THEME_DIRECTION_POSITIONS": settings.live_max_same_theme_direction_positions,
                ...
                "LIVE_ENABLE_WARMUP_MINUTES": settings.live_enable_warmup_minutes,
                ...
                "LIVE_STARTUP_MAX_NEW_POSITIONS": settings.live_startup_max_new_positions,
                "LIVE_STARTUP_RAMP_MINUTES": settings.live_startup_ramp_minutes,
